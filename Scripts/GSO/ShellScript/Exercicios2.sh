...
# 7) Certifique-se quer você está loalizado no sey diretorio home
...
# 9) Um comando útil chamado grep, é usado tipicamenyte para
# localizar um fragmento de texto dentro de arquivos
# localizafos no sistema de arquivos do computador.
# Vamos testar o grep?
