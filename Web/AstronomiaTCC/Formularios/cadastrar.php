<html>
	...
	<body class='flex' style='background-image: url("../Imagens/space.png")'>
		<div class='fullscreen flex'>
			...
			<table>
				<thead>
					<tr><th colspan='2'>Cadastrar</th></tr>
				</thead>
				<tbody>
					<form method='post' action='../verificarCadastro.php' class='body_form'>
						<tr><td colspan='2'><input type='text' name='nome' placeholder='Digite o seu nome' required></td></tr>
						...
						<tr><td colspan='2'><input type='email' name='email' placeholder='Digite seu mail' required></td></tr>
						<tr>	
